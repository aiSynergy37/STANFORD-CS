...
# Default variable scope is gloabl
...
# invocation of the function to have a totally separated set of local variables,# but that isn't quite how it works here.
local_variables() {
	local num=${num:-0}
	if [[ ${num} -lt 5 ]] ; then
		# $(( ... )) lets you do math. You can also use executable like expr
		# or bc if you prefer.
		num=$((num + 1))
		echo "(before) Num: ${num}"
		local_variables
