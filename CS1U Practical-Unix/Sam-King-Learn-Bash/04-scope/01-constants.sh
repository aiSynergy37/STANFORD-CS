...
# You can use it for constants that should never change. It can cause errors if # you add constants in scripts that other people source, though. For instance, 
